    ...
    BoxLayout:
        ...
        ScrollView:
            ...
            MDList:
                ...
                ThinBox:
                    ThinLabel:
                        text: "Total Capacitance: "
                    ThinLabel:
                        text: root.TotalCapacitance
                ThinBox:
                    ThinLabel:
                        text: "Num People: "
                    ThinLabel:
                ...
                ThinBox:
                    ThinLabel:
                        text: "Rate of Traffic: "
                    ThinLabel:
                        text: root.RateofTraffic
...
class ListMDDialog(BaseDialog):
    StoreName = StringProperty("Missing data")
    Type = StringProperty("Missing data")
    xx = StringProperty("Missing data")
    yy = StringProperty("Missing data")
    TotalCapacitance = StringProperty("Missing data")
    NumPeople = StringProperty("Missing data")
    RateofTraffic = StringProperty("Missing data")
